...
<!-- <FORM action="http://localhost:8888/i-trek/redirecting.php" USE THIS TO HOST LOCALLY -->
	 <FORM action= "http://cajubelt.scripts.mit.edu/code4good-itrek/php-login-script/redirecting.php"
