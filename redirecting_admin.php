...
if ($next) {
	header("Location: php-login-script/admin_ui.php");
}
...
echo 'trekYear : ' . json_encode($trekYear) . ','; //NEW
...
<p style="color:black">Click <input name="Submit" type="submit" style="color:grey" value="here"> to return to admin home. <br> <br>
